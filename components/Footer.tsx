        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          <div>
            <Link to="/" className="block">
              <h3 className="font-serif text-3xl text-white mb-6 hover:text-brand-green transition-colors">Röllinger GmbH</h3>
            </Link>
          ...
          <div className="flex gap-16 text-sm">
            <div className="flex flex-col gap-4">
              ...
              <span className="hover:text-brand-green transition-colors">Pilatusstrasse 4, 6340 Baar</span>
